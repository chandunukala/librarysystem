...
(4, 'img_13.jpg', 'Harry Potter Book 8', '1st edition', 'J K Rowling', 'Salani editors', 'it', '756', '20', 16, 4),
(5, 'ds.png', 'Data Structures and Also', 'Java based', 'Robert Lafore', 'Sams', 'Computer Science(all branches can use)', '264', '157', 157, 0),
(6, 'python.png', 'Python Crash Course', 'In detail python with hands on projects', 'Eric Matthes', 'No starch press', 'All Branches', '500', '3', 2, 1);
...
(1, 'Harshini', 'harshinid@gmail.com', '123', 'student'),
(2, 'Charrithavya', 'cherry12345@gmail.com', '12345', 'teacher'),
